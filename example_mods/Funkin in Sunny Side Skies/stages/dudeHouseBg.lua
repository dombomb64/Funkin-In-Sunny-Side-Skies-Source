...
function onCreate()
	-- background stuffs
	precacheImage('stages/dudeHouseSkewBg1');
	precacheImage('stages/dudeHouseSkewBg2');
	precacheImage('stages/dudeHouseSkewBg3');
	precacheImage('stages/dudeHouseSkewBg4');
	precacheImage('stages/dudeHouseSkewBg5');
	loadNormalBg();
...
function loadNormalBg()
	...
	makeLuaSprite('dudeHouseBg1', 'stages/dudeHouseBg1', -600, 600);
	...
	makeLuaSprite('dudeHouseBg2', 'stages/dudeHouseBg2', -600, -1900);
	...
	makeLuaSprite('dudeHouseBg3', 'stages/dudeHouseBg3', -600, -1900);
	...
	makeLuaSprite('dudeHouseBg4', 'stages/dudeHouseBg4', -600, -1900);
	...
	makeLuaSprite('dudeHouseBg5', 'stages/dudeHouseBg5', -600, -1900);
...
function loadSkewBg()
	...
	makeLuaSprite('dudeHouseSkewBg1', 'stages/dudeHouseSkewBg1', -600, 0);
	...
	makeLuaSprite('dudeHouseSkewBg2', 'stages/dudeHouseSkewBg2', -600, -2500);
	...
	makeLuaSprite('dudeHouseSkewBg3', 'stages/dudeHouseSkewBg3', -600, -2500);
	...
	makeLuaSprite('dudeHouseSkewBg4', 'stages/dudeHouseSkewBg4', -600, -2500);
	...
	makeLuaSprite('dudeHouseSkewBg5', 'stages/dudeHouseSkewBg5', -600, -2500);
