function onCreate()
	-- background stuffs
	precacheImage('stages/runBg1');
	precacheImage('stages/runBg2');
	loadStillBg();
...
function loadStillBg()
	...
	makeLuaSprite('arcadeBlitzNutshell1', 'stages/arcadeBlitzNutshell1', -1050, -1600);
	...
	makeLuaSprite('arcadeBlitzNutshell2', 'stages/arcadeBlitzNutshell2', -1050, -1600);
	...
	makeLuaSprite('arcadeBlitzNutshell3', 'stages/arcadeBlitzNutshell3', -1050, -1600);
