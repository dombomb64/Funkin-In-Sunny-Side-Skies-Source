...
class AchievementsMenuState extends MusicBeatState
{
	...
	override function create() {
		...
		menuBG.makeGraphic(Std.int(menuBG.width), Std.int(menuBG.height), 0xFF171717);
		add(menuBG);
		...
		for (i in 0...options.length) {
			...
			var optionText:Alphabet = new Alphabet(280, 300, Achievements.isAchievementUnlocked(achieveName) ? Achievements.achievementsStuff[achievementIndex[i]][0] : '?', false, 'alphabetWhite');
