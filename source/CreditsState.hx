...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['No Credits', 			'questionMark', 	'No credits are loaded. Please add credits to your mod.', 		'https://github.com/ShadowMario/FNF-PsychEngine/wiki#q-how-can-i-create-a-custom-credits', 'FDE871']
		];
		...
		for (i in 0...creditsStuff.length)
		{
			...
			var optionText:Alphabet = new Alphabet(0, 320, creditsStuff[i][0], !isSelectable, 'alphabetWhite');
			optionText.isMenuItem = true;
			optionText.isWebtoonMenu = true;
			optionText.targetY = i;
			optionText.changeX = false;
			optionText.snapToPosition();
			optionText.boldOffset = -70;
			grpOptions.add(optionText);

			if(isSelectable) {
				optionText.color = FlxColor.fromString(creditsStuff[i][4]);
				optionText.x = 20 + 150;
				if (optionText.color == FlxColor.BLACK || optionText.color == 0xFF222222)
					optionText.color = FlxColor.WHITE;

				var weebtown:AttachedSprite = new AttachedSprite('webtoonFreeplay1');
				weebtown.sprTracker = optionText;
				weebtown.copyAlpha = false;
				weebtown.xAdd = -20 - 150;
				weebtown.yAdd = -33 - 2;
				weebtown.color = FlxColor.fromString(creditsStuff[i][4]);
				weebtownGrp1.add(weebtown);

				var weebtown:AttachedSprite = new AttachedSprite('webtoonFreeplay2Dark');
				weebtown.sprTracker = optionText;
				weebtown.copyAlpha = false;
				weebtown.xAdd = -20 - 150;
				weebtown.yAdd = -33 - 2;
			...
			{
				optionText.image = 'alphabet';
				optionText.alignment = CENTERED;
				optionText.x = FlxG.width / 2;
				//optionText.updateImage();
			}
		}
	...
	function pushModCreditsToList(folder:String)
	{
		...
		//if (creditsStuff[creditsStuff.length - 1][0] == 'No Credits')
			//creditsStuff.pop();
