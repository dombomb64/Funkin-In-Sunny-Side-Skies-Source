...
enum abstract Action(String) to String from String
{
	...
	var RESET = "reset";
	var DEBUG_1 = "debug_1";
	var DEBUG_1_P = "debug_1-press";
	var DEBUG_1_R = "debug_1-release";
	var DEBUG_2 = "debug_2";
	var DEBUG_2_P = "debug_2-press";
	var DEBUG_2_R = "debug_2-release";
}
#else
@:enum
...
class Controls extends FlxActionSet
{
	...
	var _debug_1P = new FlxActionDigital(Action.DEBUG_1_P);
	var _debug_1R = new FlxActionDigital(Action.DEBUG_1_R);
	var _debug_2 = new FlxActionDigital(Action.DEBUG_2);
	var _debug_2P = new FlxActionDigital(Action.DEBUG_2_P);
	var _debug_2R = new FlxActionDigital(Action.DEBUG_2_R);
	...
	public var DEBUG_1_P(get, never):Bool;

	inline function get_DEBUG_1_P()
		return _debug_1P.check();

	public var DEBUG_1_R(get, never):Bool;

	inline function get_DEBUG_1_R()
		return _debug_1R.check();

	public var DEBUG_2(get, never):Bool;

	inline function get_DEBUG_2()
		return _debug_2.check();

	public var DEBUG_2_P(get, never):Bool;

	inline function get_DEBUG_2_P()
		return _debug_2P.check();

	public var DEBUG_2_R(get, never):Bool;

	inline function get_DEBUG_2_R()
		return _debug_2R.check();
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch (control)
		{
			...
			case DEBUG_1:
				func(_debug_1, PRESSED);
				func(_debug_1P, JUST_PRESSED);
				func(_debug_1R, JUST_RELEASED);
			case DEBUG_2:
				func(_debug_2, PRESSED);
				func(_debug_2P, JUST_PRESSED);
				func(_debug_2R, JUST_RELEASED);
		}
	}
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.DEBUG_1, keysMap.get('debug_1'));
				inline bindKeys(Control.DEBUG_2, keysMap.get('debug_2'));
			case Duo(true):
				...
				inline bindKeys(Control.DEBUG_1, [SEVEN]);
				inline bindKeys(Control.DEBUG_2, [EIGHT]);
			case Duo(false):
		...
		switch (scheme)
		{
			case Solo:
				...
				bindKeys(Control.DEBUG_1, keysMap.get('debug_1'));
				bindKeys(Control.DEBUG_2, keysMap.get('debug_2'));
			case Duo(true):
